...
export default function Tasks({
  ...
  useEffect(() => {
    fetchTasks();
  }, [currentPage, totalPages, statusFilter]);
        ...
        !loading && (
          <Paper>
            <p className="text-lg text-gray-500 text-center tracking-wider">
              No Task Available, click on `New Task` button for creating new
              one.
            </p>
          </Paper>
        )
